                ...
                <html>
                    <body style="font-family: Arial, sans-serif; margin: 0; padding: 0;">
                        ...
                        <div style="padding: 20px;">
                            ...
                            <p style="margin-top: 20px;">Clique <a href="https://www.itelectric.com/login" style="color: #4CAF50;">aqui</a> para acessar o sistema.</p>
                            <p>Atenciosamente,</p>
                    ...
                    <body style="font-family: Arial, sans-serif; margin: 0; padding: 0;">
                        ...
                        <div style="padding: 20px;">
                            ...
                            <div style="text-align: center; margin-top: 20px;">
                                <a href="https://www.iteletric.com/login" style="background-color: #20494d; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-size: 16px;">
                                    Ver Orçamento
                                </a>
                            </div>
